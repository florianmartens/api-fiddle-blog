...
While altruism surly plays a role in open souring software, it can be good for business too. Small comapnies often open source 
products so they get adopted by large organizations quicker! This model is called 
[Comercial Open Source Software](https://cal.com/blog/open-source) (COSS). 
...
self-hosted software easier then ever.
