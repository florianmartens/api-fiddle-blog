...
API Contracts are documents that describe APIs. Popular formats include [OpenAPI](https://www.openapis.org/) and [AsyncAPI](https://www.asyncapi.com/).
...
Moreover, API contracts play a crucial role in enhancing security. They serve as our best defense against [excessive data exposure](https://owasp.org/API-Security/editions/2019/en/0xa3-excessive-data-exposure/), a top attack vector for APIs on the internet. 
...
Another approach is to write API contracts by hand. In the real world, most of the best API contracts are written by hand. But 
